#!/usr/bin/env python3
"""
Autonomous General Agent Test Runner.

Dedicated runner for the autonomous general agent (Deep Agent + git sandbox)
test case.  This is the counterpart of ``test_general_agent_runner.py``
which tests the structured orchestration general agent.

Usage:
    python -m test_scripts.test_auto_general_agent_runner
    python -m test_scripts.test_auto_general_agent_runner --list
    python -m test_scripts.test_auto_general_agent_runner -r 1 4
"""
...
_log_file = os.path.join(_log_dir, f"auto_general_agent_runner_{_log_ts}.log")
...
CASES = [
    ("auto_general", "test_scripts.cases.case_auto_general_agent", "Auto General Agent (deep agent + git sandbox)"),
]
...
def main():
    parser = argparse.ArgumentParser(description="Autonomous General Agent Test Runner")
